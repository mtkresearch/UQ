...
$PYTHON -m sep.transfer.transfer \
  ...
  $COMMON --out-dir sep_scratch/transfer/all_maps/llama2_to_mistral
...
$PYTHON -m sep.transfer.transfer \
  ...
  $COMMON --out-dir sep_scratch/transfer/all_maps/llama32-1b_to_llama31-8b
...
$PYTHON -m sep.transfer.transfer \
  ...
  $COMMON --out-dir sep_scratch/transfer/all_maps/llama31-8b_to_qwen3-8b
...
$PYTHON -m sep.transfer.transfer \
  ...
  $COMMON --out-dir sep_scratch/transfer/all_maps/llama31-8b_to_phi4
...
$PYTHON -m sep.transfer.transfer \
  ...
  $COMMON --out-dir sep_scratch/transfer/all_maps/llama31-8b_to_gemma
...
$PYTHON -m sep.transfer.transfer \
  ...
  $COMMON --out-dir sep_scratch/transfer/all_maps/llama31-8b_to_nemo

echo ""
echo "=== Generating aggregate figures ==="
