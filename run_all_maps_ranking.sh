...
$PYTHON -m sep.transfer.transfer \
  ...
  $COMMON --out-dir sep_scratch/transfer/all_maps_ranking/llama2_to_mistral
...
$PYTHON -m sep.transfer.transfer \
  ...
  $COMMON --out-dir sep_scratch/transfer/all_maps_ranking/llama32-1b_to_llama31-8b
...
$PYTHON -m sep.transfer.transfer \
  ...
  $COMMON --out-dir sep_scratch/transfer/all_maps_ranking/llama31-8b_to_qwen3-8b
...
$PYTHON -m sep.transfer.transfer \
  ...
  $COMMON --out-dir sep_scratch/transfer/all_maps_ranking/llama31-8b_to_phi4
...
$PYTHON -m sep.transfer.transfer \
  ...
  $COMMON --out-dir sep_scratch/transfer/all_maps_ranking/llama31-8b_to_gemma
...
$PYTHON -m sep.transfer.transfer \
  ...
  $COMMON --out-dir sep_scratch/transfer/all_maps_ranking/llama31-8b_to_nemo
